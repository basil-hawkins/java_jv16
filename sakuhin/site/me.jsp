...
<html>
  ...
  <div id="waku">
    <div id="zentai">
      ...
      <nav>
        <ul class="me">
          <li><h1 class="me">ユーザー名</h1></li>
          <li><a href="toukou.html"><img src="images/tuika.png" class="meaikon"></a></li>
          <li><a href="settei.html"><img src="images/settei.png" class="meaikon"></a></li>
        </ul>
      </nav>

      <p class="follow"><a href="follow.html" class="follow"> フォロー</a> &emsp;<a href="follower.html" class="follow">フォロワー</a></p>

      <h1 class="icon">○</h1>

    <table id="me">
      <tr>
        <td><a href="prof.html">プロフィールを編集</a></td>
      </tr>
      <tr>
        <td><a href="kounyuu.html">購入したアイテム一覧</a></td>
      </tr>
    </table>
