...
<body>
<form method="post" action="/JV16/customer_deleteout.jsp">
<table border="1">
	<tr><th>削除</th><th>顧客No.</th><th>顧客ID</th><th>パスワード</th><th>氏名</th></tr>
...
%>
	...
	<td align='center'bgcolor='blue'>
		<input type="radio" name="cus_no" value="<%= list.get(i).get("cus_no") %>"></td>
